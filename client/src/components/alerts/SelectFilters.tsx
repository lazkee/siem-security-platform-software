...
export default function SelectFilters ({
  ...
  return (
    <>
      <div className="flex flex-col col-span-2 gap-[4px]">
        <label className="px-1! block text-[11px] text-gray-400 mb-1 uppercase tracking-wider font-semibold">Severity</label>
      ...
      <div className="flex flex-col col-span-2 gap-[4px]">
        <label className=" px-1! block text-[11px] text-gray-400 mb-1 uppercase tracking-wider font-semibold">Status</label>
      ...
      <div className="flex flex-col col-span-2 gap-[4px]">
        <label className="px-1! block text-[11px] text-gray-400 mb-1 uppercase tracking-wider font-semibold">Sort By</label>
      ...
      <div className="flex flex-col col-span-2 gap-[4px]">
        <label className="px-1! block text-[11px] text-gray-400 mb-1 uppercase tracking-wider font-semibold">Order</label>
